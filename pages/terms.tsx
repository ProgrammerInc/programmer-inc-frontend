...
const Home = () => {
  return (
    <Layout>
      <div className="programmer-terms">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Programmer Incorporated LLC, 5700
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Programmer Incorporated,
              accessible from{" "}
              <a
                href="https://programmer.inc"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://programmer.inc
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://programmer.inc/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://programmer.inc/contact
            </a>
          </li>
        </ul>
      </div>
